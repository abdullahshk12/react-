  ...
  <div className="mt-20">
    ...
    <div className=" flex flex-wrap">
        {pricingOptions.map((option, index)=>(
            <div key={index} className="w-full sm:1/2 lg:1/3 p-2">
                ...
                {option.title === "pro" && (
                    ...
                    <a href="#" className=" inline-flex justify-center items-center text-center h-12 w-full p-5 mt-20 tracking-tight text-xl hover:bg-orange-600 border border-orange-600 rounded-lg transition duration-200 "  >Subscribe</a>
                </div>
